...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark  shadow-sm" style="background:  #023342;">
            <div class="container">
                @guest
						...
						@auth
							...
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
									...
									@endadmin
									<a class="dropdown-item "  href="{{ route('libros.index') }}">Libros</a>
								</div>
							</li>
                    ...
                    <ul class="navbar-nav ml-auto">
						...
						@else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
									<a class="dropdown-item" href="{{ route('usuarios.edit',auth()->user()) }}">Mi Perfil</a>
